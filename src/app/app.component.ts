...
export class MyApp {
  ...
  constructor(
    ...
    platform.ready().then(() => {
      ...
      if (this.platform.is("android")) {
        if (this.genericService.getColorHex()) {
          statusBar.backgroundColorByHexString(
            this.genericService.getColorHex()
          );
        } else {
      ...
      let firstTime = this.localStorageEncryptService.getFromLocalStorage(
        "firstTime"
      );
      if (!firstTime) {
      ...
      if (!this.localStorageEncryptService.getFromLocalStorage("phoneToken")) {
        this.fcm.getToken().then(token => {
          ...
          this.genericService
            .sendPutRequest(environment.usuarios, body)
            .subscribe(
              (response: any) => {
      ...
      switch (environment.perfil.activo) {
        case 1:
          this.pages.push(
            new Menu(
              "Mi perfil",
              "assets/imgs/perfil/social-media.png",
              "#7d3a63",
              PerfilPage
            )
          );
          ...
          this.pages.push(
            new Menu(
              ...
              "assets/imgs/lista-carrito/trolley.png",
              "#7d3a63",
          ...
          this.pages.push(
            new Menu(
              ...
              "assets/imgs/direcciones/markerD.png",
              "#7d3a63",
              DireccionesPage
            )
          );
          ...
          this.pages.push(
            new Menu(
              "Acerca de",
              "assets/imgs/menu/interface.png",
              "#7d3a63",
              AcercaDePage
            )
          );
